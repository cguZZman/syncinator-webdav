...
public class OneDriveDavResourceFactory implements DavResourceFactory {
	...
	private DavResource createResource(DavResourceLocator locator, DavSession davSession, DavServletRequest request)
			throws DavException {
		...
		if (file == null) {
			...
			return new DavNullResource(this, locator, davSession, cassandraService, fileStorageService,
					isCreateCollection);
		} else {
